 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        var counting = setInterval((function() {
            var loader = document.getElementById("preloader-percentage");
            var currval = parseInt(loader.innerHTML);
            var Width = 99 - currval;
            var loadscreen = document.getElementById("preloader-progress");
            loader.innerHTML = ++currval;
            if (currval > 89) {
                loader.innerHTML = 90;
                if (window.jQuery) {
                    loader.innerHTML = 95;
                    if ("interactive" == document.readyState) loader.innerHTML = 99;
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) {
                let heroContent = new core(".hero-text", {
                    modules: [ Navigation, Controller, Parallax, Pagination, Scrollbar, Autoplay ],
                    speed: 2400,
                    grabCursor: true,
                    navigation: {
                ...
                let heroImg = new core(".hero-images", {
                    modules: [ Navigation, Autoplay, Controller, Parallax, Pagination, Scrollbar ],
                    speed: 2400,
                    parallax: true,
                    pagination: {
                        el: ".hero-controls__count",
                        type: "fraction"
                    }
                });
                heroImg.controller.control = heroContent;
                heroContent.controller.control = heroImg;
                new core(".approach-slider", {
                    modules: [ Navigation, Autoplay, Pagination ],
                    speed: 1400,
                    grabCursor: true,
                    spaceBetween: 80,
                    navigation: {
                        prevEl: ".approach-controls__arrows .swiper-arrows__btn_prev",
                        nextEl: ".approach-controls__arrows .swiper-arrows__btn_next"
                    },
                    pagination: {
                        el: ".approach-controls__dotts",
                        clickable: true
                    },
                    autoplay: {
                        delay: 4e3
                ...
                new core(".slider-partners", {
                    ...
                    grabCursor: true,
                    navigation: {
                        prevEl: ".partners-controls__arrows .swiper-arrows__btn-arrow_prev",
                        nextEl: ".partners-controls__arrows .swiper-arrows__btn-arrow_next"
                    },
                    autoplay: {
                        delay: 3e3
                    },
                ...
                new core(".sevenavenue", {
                    modules: [ Navigation ],
                    speed: 1400,
                    autoHeight: true,
                    spaceBetween: 80,
                    navigation: {
                        prevEl: ".sevenavenue-controls__arrows .swiper-arrows__btn-arrow_prev",
                        nextEl: ".sevenavenue-controls__arrows .swiper-arrows__btn-arrow_next"
                    }
                });
                new core(".palyanytsya", {
                    modules: [ Navigation ],
                    speed: 1400,
                    autoHeight: true,
                    spaceBetween: 80,
                    navigation: {
                        prevEl: ".palyanytsya-controls__arrows .swiper-arrows__btn-arrow_prev",
                        nextEl: ".palyanytsya-controls__arrows .swiper-arrows__btn-arrow_next"
                    }
                });
                new core(".anthill", {
                    modules: [ Navigation ],
                    ...
                    spaceBetween: 80,
                    navigation: {
                        prevEl: ".anthill-controls__arrows .swiper-arrows__btn-arrow_prev",
                        nextEl: ".anthill-controls__arrows .swiper-arrows__btn-arrow_next"
                    }
                });
            }
        }
...
***************************************************************************** */
        ...
        lightgallery_es5(document.getElementById("sevenavenue"), {
            licenseKey: "7EC452A9-0CFD441C-BD984C7C-17C8456E",
            selector: ".gallery-project__item",
            download: false,
            share: false,
            mobileSettings: {
                controls: true,
        ...
        lightgallery_es5(document.getElementById("anthill"), {
            licenseKey: "7EC452A9-0CFD441C-BD984C7C-17C8456E",
            selector: ".gallery-project__item",
            download: false,
            share: false,
        ...
        lightgallery_es5(document.getElementById("palyanytsya"), {
            licenseKey: "7EC452A9-0CFD441C-BD984C7C-17C8456E",
            selector: ".gallery-project__item",
            download: false,
            share: false,
        ...
        lightgallery_es5(document.getElementById("article-gallery"), {
            licenseKey: "7EC452A9-0CFD441C-BD984C7C-17C8456E",
            selector: ".article-gallery__img",
            download: false,
            share: false,
            mobileSettings: {
                controls: true,

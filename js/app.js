...
***************************************************************************** */
        ...
        window.onload = function() {
            ...
            function documentActions(e) {
                const targetElement = e.target;
                if (window.screen.width >= 991.98) if (targetElement.classList.contains("language-switcher__btn")) targetElement.closest(".language-switcher").classList.toggle("_hover"); else if (!e.target.closest(".language-switcher._hover")) _removeClasses(document.querySelectorAll(".language-switcher"), "_hover");
            }
        };
        window["FLS"] = true;
        isWebp();
